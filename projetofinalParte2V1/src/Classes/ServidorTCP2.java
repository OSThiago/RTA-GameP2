...
public class ServidorTCP2 extends Thread{
	//Atributos
		...
		//Construtor
		public ServidorTCP2(Socket conexao, List<ObjectOutputStream> saidas, Principal principal) {
		...
		public ServidorTCP2(Principal principal) {
			this.vivo = true;
			this.situacao = SituacaoInicio.INICIAL_CRIAR;
			this.principal = principal;
		}
		...
		public void levantarServidor() {
			...
			try {
				...
				while(true) {
					...
					ServidorTCP2 novoServidorTCP2 = new ServidorTCP2(conexao,saidas,this.principal);
					novoServidorTCP2.setSituacao(situacao);
					novoServidorTCP2.start();
